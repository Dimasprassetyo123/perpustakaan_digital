        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="tableBuku" class="table table-hover align-middle">
                        ...
                        <tbody>
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{-- DETAIL --}}
                                        <a href="{{ route('buku.show', $item->id_buku) }}" class="btn btn-sm btn-info"
                                            title="Detail">
                                            <i class="mdi mdi-eye"></i>
                                        </a>

                                        {{-- EDIT --}}
                                        <a href="{{ route('buku.edit', $item->id_buku) }}" class="btn btn-sm btn-warning"
                                            title="Edit">
